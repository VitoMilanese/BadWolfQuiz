...
Bad Wolf Quiz is source-available under the [MIT License + Commons Clause License Condition v1.0 with BadWolfQuiz-specific terms](LICENSE). Monetizing BadWolfQuiz itself is restricted, while surrounding monetized activity may use BadWolfQuiz as a tool only where the complete license permits that use.

The license also contains an absolute **BadWolfQuiz Russia-Related Use Prohibition**. No rights are granted under this license for Russia-related uses defined there, including use by Russian persons/entities or Russia-affiliated projects, use by persons or entities of any nationality that knowingly cooperate with or materially support Russian parties or Russian-market activity, use directed toward a Russian audience, and use for Russian content as defined in the license. This prohibition has no exception, waiver, authorization, approval, or separate-written-permission mechanism under this license. The complete and authoritative terms are in [`LICENSE`](LICENSE).

Bad Wolf Quiz має доступний вихідний код і поширюється за [MIT License + Commons Clause License Condition v1.0 з додатковими умовами BadWolfQuiz](LICENSE). Монетизація самого BadWolfQuiz обмежена, а зовнішня монетизована діяльність може використовувати BadWolfQuiz як інструмент лише тоді, коли таке використання дозволене повним текстом ліцензії.

Ліцензія також містить абсолютну **заборону BadWolfQuiz на використання, пов’язане з Росією**. Ця ліцензія не надає прав на визначені в ній види використання, пов’язані з Росією, зокрема російським особам/структурам і пов’язаним з Росією проєктам; особам або організаціям будь-якої країни чи національності, які свідомо співпрацюють із російськими сторонами або суттєво підтримують російську чи орієнтовану на російський ринок діяльність; для діяльності, спрямованої на російську аудиторію; а також для російського контенту в значенні, визначеному ліцензією. У межах цієї ліцензії для цієї заборони немає винятку, відмови від застосування, дозволу, погодження чи механізму окремого письмового дозволу. Повний і юридично визначальний текст міститься у [`LICENSE`](LICENSE).
