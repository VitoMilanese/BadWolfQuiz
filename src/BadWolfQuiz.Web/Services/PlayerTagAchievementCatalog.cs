...
public static class PlayerTagAchievementCatalog
{
    ...
    [
        ...
        new("AudioQuestions25", "🎧", false, PlayerAchievementMetric.TaggedAnswers, 25, "AudioQuestions25"),
        new("VideoQuestions25", "🎥", false, PlayerAchievementMetric.TaggedAnswers, 25, "VideoQuestions25"),
    ...
    private static readonly IReadOnlyDictionary<string, HashSet<string>> TagGroups =
        new Dictionary<string, HashSet<string>>(StringComparer.Ordinal)
        {
            ...
            ["AudioQuestions25"] = Tags("аудіопитання", "audio question"),
            ["VideoQuestions25"] = Tags("відеопитання", "video question"),
