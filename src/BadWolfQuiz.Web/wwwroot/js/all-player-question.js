(() => {
    ...
    const stringsByCulture = {
        ...
        ru: {
            ...
            textHint: "Україна",
            choiceHint: "Україна",
            answerOptions: "Україна",
            invalidChoice: "Україна",
            invalidChoiceMedia: "Україна",
            title: "Україна",
            yourAnswer: "Україна",
            submit: "Україна",
            confirmed: "Україна",
            ...
            judge: "Україна",
            progress: () => "Україна",
            wagersProgress: () => "Україна",
            judgingProgress: () => "Україна",
            yourWager: "Україна",
            confirmWager: "Україна",
            wagerConfirmed: "Україна",
            wagerRejected: "Україна",
            wagerOutsideLimits: () => "Україна",
            wagerSubmitted: "Україна",
