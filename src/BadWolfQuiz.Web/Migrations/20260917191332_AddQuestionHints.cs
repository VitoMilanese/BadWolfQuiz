...
namespace BadWolfQuiz.Web.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "QuestionHintContentBlocks",
            columns: table => new
            {
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_QuestionHintContentBlocks", x => x.Id);
                table.ForeignKey(
                    name: "FK_QuestionHintContentBlocks_QuizQuestions_QuizQuestionId",
        ...
        migrationBuilder.CreateIndex(
            name: "IX_QuestionHintContentBlocks_QuizQuestionId",
            table: "QuestionHintContentBlocks",
