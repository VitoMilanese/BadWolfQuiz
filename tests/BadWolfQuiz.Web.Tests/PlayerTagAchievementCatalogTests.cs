...
public sealed class PlayerTagAchievementCatalogTests
{
    ...
    [InlineData("AudioQuestions25", "аудіопитання")]
    [InlineData("AudioQuestions25", "audio question")]
    [InlineData("VideoQuestions25", "відеопитання")]
    [InlineData("VideoQuestions25", "video question")]
