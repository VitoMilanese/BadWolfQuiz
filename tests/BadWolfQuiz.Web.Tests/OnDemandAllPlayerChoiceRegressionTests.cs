...
public sealed class OnDemandAllPlayerChoiceRegressionTests
{
    ...
    public void Editor_and_runtime_expose_the_on_demand_choice_flow()
    {
        ...
        Assert.Contains("Label_AllPlayerChoiceOnDemand", editor, StringComparison.Ordinal);
        ...
        Assert.Contains("AllPlayerMultipleChoiceOnDemand", editorModel, StringComparison.Ordinal);
        ...
        Assert.Contains("RevealAnswerOptionsOnDemand", runtime, StringComparison.Ordinal);
        Assert.Contains("AreAllPlayerChoiceOptionsRevealed", runtime, StringComparison.Ordinal);
        Assert.Contains("AllPlayerChoiceRevealLocked", runtime, StringComparison.Ordinal);
        Assert.Contains("AllPlayerChoiceOptionsRevealed", state, StringComparison.Ordinal);
