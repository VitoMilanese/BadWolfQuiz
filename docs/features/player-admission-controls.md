...
2. **Automatically accept new players** — enables or disables automatic approval for newly connected players who would otherwise enter the waiting-for-approval state.
